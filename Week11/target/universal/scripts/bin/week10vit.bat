@REM week10vit launcher script
@REM
@REM Environment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM WEEK10VIT_config.txt found in the WEEK10VIT_HOME.
...
if "%WEEK10VIT_HOME%"=="" (
  ...
  set "WEEK10VIT_HOME=%~dp0\\.."
) else (
  set "APP_HOME=%WEEK10VIT_HOME%"
)
...
set "CFG_FILE=%APP_HOME%\WEEK10VIT_config.txt"
set CFG_OPTS=
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running week10vit.
  echo.
...
"%_JAVACMD%" !_JAVA_OPTS! !WEEK10VIT_OPTS! -cp "%APP_CLASSPATH%" %MAIN_CLASS% !_APP_ARGS!
